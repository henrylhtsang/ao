...
class ConditionalFeedForwardAOQuantizable(nn.Module):
    ...
    def forward(
        ...
        if x.shape[0]==1 and not isinstance(self.w1, FakeExtraDimTensor):
            ...
            def group_tokens_by_expert(ordered_token_indices, cum_tokens_per_expert, expert_list):
                token_indices_per_expert = [ordered_token_indices[cum_tokens_per_expert[expert]:cum_tokens_per_expert[expert+1]].to(torch.int64) for expert in expert_list] # [T'(e1)], [T'(e2)] ...
